...
QT_MOC_LITERAL(1, 11, 4), // "s_c1"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 4), // "s_c3"
QT_MOC_LITERAL(4, 22, 9), // "changeAlt"
QT_MOC_LITERAL(5, 32, 4), // "cam1"
QT_MOC_LITERAL(6, 37, 4), // "cam3"
QT_MOC_LITERAL(7, 42, 4), // "altu"
QT_MOC_LITERAL(8, 47, 2) // "nu"

    },
    "MyGLWidget\0s_c1\0\0s_c3\0changeAlt\0cam1\0"
    "cam3\0altu\0nu"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->s_c1(); break;
        case 1: _t->s_c3(); break;
        case 2: _t->changeAlt((*reinterpret_cast< const int(*)>(_a[1]))); break;
        case 3: _t->cam1(); break;
        case 4: _t->cam3(); break;
        case 5: _t->altu((*reinterpret_cast< const int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGLWidget::s_c1)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyGLWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGLWidget::s_c3)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGLWidget::changeAlt)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::s_c1()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MyGLWidget::s_c3()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void MyGLWidget::changeAlt(const int & _t1)
{
